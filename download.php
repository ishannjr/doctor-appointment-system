...
if(isset($_GET["id"]))
{
	...
	foreach($hospital_data as $hospital_row)
	{
		...
		$html .= '<h2 align="center">'.$hospital_row['hospital_name'].'</h2><br></br><br></br><br></br>
		<p align="center">'.$hospital_row['hospital_address'].'</p><br></br>
		<p align="center"><b>Contact No. - </b>'.$hospital_row['hospital_contact_no'].'</p><br></br><br></br><br></br></td></tr>
		';
	}
	...
	foreach($appointment_data as $appointment_row)
	{
		...
		$html .= '
		<h4 align="center">Patient Details</h4><br></br><br></br><br></br><br></br>
		...
		$html .= '</table><br /><hr />
		<h4 align="center">Appointment Details</h4><br></br><br></br><br></br>
		<table border="0" cellpadding="5" cellspacing="5" width="100%">
			<tr>
